    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8" style={{ backgroundColor: '#f5f2ea' }}>
        <div className="w-full max-w-sm">
          ...
          <button
            onClick={handleLogin}
            className="w-full flex items-center justify-center gap-3 bg-white border border-sand-300 shadow-sm rounded-xl px-4 py-3.5 text-sm font-medium text-gray-700 hover:bg-sand-50 hover:shadow-md transition-all"
          >
